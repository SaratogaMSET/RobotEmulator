...
//      return status.getPointer().address().toUWord().toPrimitive();
    ...
    /// Trigger lines are not supported or isEnabled. For PXI chasses, identify the controller and chassis via MAX.
    ...
    /// The specified RIO event has already been isEnabled for this session.
    public static final int kRIOStatusEventEnabled = kRioStatusOffset - 71;

    /// The specified RIO event has not been isEnabled for this session.

...
/**
 * The {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser} class is a useful tool for presenting a selection
 * of options to the {@link edu.wpi.first.wpilibj.smartdashboard.SmartDashboard}.
 * <p/>
 * <p>For instance, you may wish to be able to select between multiple
 * isAutonomousMode modes. You can do this by putting every possible {@link Command}
 * you want to run as an isAutonomousMode into a {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser} and then put
 * it into the {@link edu.wpi.first.wpilibj.smartdashboard.SmartDashboard} to have a list of options appear on the
 * laptop. Once isAutonomousMode starts, simply ask the {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser} what
...
public class SendableChooser implements Sendable {
    ...
    /**
     * Instantiates a {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser}.
     */
     ...
     * {@link edu.wpi.first.wpilibj.smartdashboard.SmartDashboard} on the desktop, the object will appear as the
     * given name.
     *
     ...
     * {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser#addObject(String, Object) addObject(...)}

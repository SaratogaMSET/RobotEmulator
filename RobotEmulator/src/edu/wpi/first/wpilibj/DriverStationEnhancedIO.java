...
//                    input_t.size));
     ...
     * If Enhanced mode is not isEnabled when this is called, it will return kUnknown.
     *
     ...
     * <p/>
     * If configured to kInputPullUp, the selected DIO line will be tri-stated with a 5k-Ohm internal pull-up resistor isEnabled.
     * <p/>
     * If configured to kInputPullDown, the selected DIO line will be tri-stated with a 5k-Ohm internal pull-down resistor isEnabled.
     * <p/>
     ...
     * analog comparators on those 2 DIO lines.  When isEnabled, the lines are tri-stated and will accept analog voltages
     ...
     * <p/>
     * This has the side effect of forcing the Driver Station to switch to Enhanced mode if it's not when called.
     * If Enhanced mode is not isEnabled when this is called, it will return 0.
     *
     ...
     * <p/>
     * The index functionality can be isEnabled or disabled using SetEncoderIndexEnable().
     *
     ...
     * If you use this method with Index isEnabled, you may get unexpected results.
     *
     ...
     * <p/>
     * This has the side effect of forcing the Driver Station to switch to Enhanced mode if it's not when called.
     * If Enhanced mode is not isEnabled when this is called, it will return false.
     *
     * @param encoderNumber The quadrature encoder. [1,2]
     * @return Is the index channel of the encoder isEnabled.
     */
     ...
     * <p/>
     * When isEnabled, the decoder's counter will be reset to 0 when A, B, and Index are all low.
     *
     * @param encoderNumber The quadrature encoder. [1,2]
    ...
    /**
     * Set the percent duty-cycle to output on a PWM isEnabled DIO line.
     * <p/>

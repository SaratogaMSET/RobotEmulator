...
public class Encoder extends SensorBase implements CounterBase, PIDSource, ISensor, LiveWindowSendable {
    ...
    private final int aChannel;
    private final int bChannel;
    ...
    private void initEncoder(boolean reverseDirection) {
        ...
        RobotEmulator.getInstance().addEncoder(this);
    }
    ...
    public Encoder(final int aSlot, final int aChannel,
        ...
        m_aSource = new DigitalInput(aSlot, this.aChannel, false);
        this.bChannel = bChannel;
        m_bSource = new DigitalInput(bSlot, this.bChannel, false);
    ...
    public Encoder(final int aSlot, final int aChannel,
        ...
        m_allocatedB = true;
        m_allocatedI = false;
        m_aSource = new DigitalInput(aSlot, aChannel, false);
        m_bSource = new DigitalInput(bSlot, bChannel, false);
    ...
    public Encoder(final int aSlot, final int aChannel,
        ...
        m_aSource = new DigitalInput(aSlot, aChannel, false);
        m_bSource = new DigitalInput(bSlot, bChannel, false);
        m_indexSource = new DigitalInput(indexSlot, indexChannel, false);
        this.aChannel = aChannel;
        this.bChannel = bChannel;
        initEncoder(reverseDirection);
    }
    ...
    public Encoder(final int aChannel, final int bChannel, boolean reverseDirection) {
        ...
        m_allocatedB = true;
        m_allocatedI = false;
        m_aSource = new DigitalInput(aChannel, false);
        m_bSource = new DigitalInput(bChannel, false);
        this.aChannel = aChannel;
        this.bChannel = bChannel;
        initEncoder(reverseDirection);
    }
    ...
    public Encoder(final int aChannel, final int bChannel, final int indexChannel, boolean reverseDirection) {
        ...
        m_aSource = new DigitalInput(aChannel, false);
        m_bSource = new DigitalInput(bChannel, false);
        m_indexSource = new DigitalInput(indexChannel, false);
        this.aChannel = aChannel;
        this.bChannel = bChannel;
        initEncoder(reverseDirection);
    }
    ...
    public Encoder(DigitalSource aSource, DigitalSource bSource, boolean reverseDirection) {
        ...
        m_bSource = bSource;
        aChannel = aSource.getChannelForRouting();
        bChannel = bSource.getChannelForRouting();
        initEncoder(reverseDirection);
    }
...
//        }
//        return value;
        return RobotEmulator.getInstance().getEncoderValue(this);
    }

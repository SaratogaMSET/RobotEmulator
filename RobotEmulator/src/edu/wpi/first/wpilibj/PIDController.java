...
public class PIDController implements IUtility, LiveWindowSendable, Controller {
    ...
    private boolean m_enabled = false;            //is the pid controller isEnabled
    ...
    public synchronized void enable() {
        ...
        if (table != null) {
            table.putBoolean("isEnabled", true);
        }
    }
    ...
    public synchronized void disable() {
        ...
        if (table != null) {
            table.putBoolean("isEnabled", false);
        }
    }

    /**
     * Return true if PIDController is isEnabled.
     */
    ...
    public void initTable(ITable table) {
        ...
        if (table != null) {
            ...
            table.putBoolean("isEnabled", isEnable());

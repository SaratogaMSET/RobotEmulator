 ...
 * subclassed by a user creating a robot program. Overridden isAutonomousMode() and
...
//        NetworkTable.getTable("LiveWindow").getSubTable("~STATUS~").putBoolean("LW Enabled", false);
     ...
     *
     * @return Is the system active (i.e. PWM motor outputs, etc. isEnabled)?
     */
...
//        return null;
    ...
    /**
     * Determine if the Robot is currently isEnabled.
     *
     * @return True if the Robot is currently isEnabled by the field controls.
     */
...
//        }
    ...
    public final void startApp() throws MIDletStateChangeException {
        ...
        try {
            ...
            Platform.runLater(new Runnable() {
                @Override
                public void run() {
                    RobotEmulator.showErrorDialog(t);
                }
            });
            errorOnExit = true;
        } finally {
     ...
     *                      at this time.
     * @throws javax.microedition.midlet.MIDletStateChangeException if there is an exception in

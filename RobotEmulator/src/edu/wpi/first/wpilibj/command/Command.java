 ...
 * Every command can be started with a call to {@link edu.wpi.first.wpilibj.command.Command#start() start()}.
 * Once a command is started it will call {@link edu.wpi.first.wpilibj.command.Command#initialize() initialize()}, and then
 * will repeatedly call {@link edu.wpi.first.wpilibj.command.Command#execute() execute()} until the {@link edu.wpi.first.wpilibj.command.Command#isFinished() isFinished()}
 * returns true.  Once it does, {@link edu.wpi.first.wpilibj.command.Command#end() end()} will be called.
 * <p/>
 * <p>However, if at any point while it is running {@link edu.wpi.first.wpilibj.command.Command#cancel() cancel()} is called, then
 * the command will be stopped and {@link edu.wpi.first.wpilibj.command.Command#interrupted() interrupted()} will be called.</p>
 * <p/>
 * <p>If a command uses a {@link Subsystem}, then it should specify that it does so by
 * calling the {@link edu.wpi.first.wpilibj.command.Command#requires(Subsystem) requires(...)} method
 * in its constructor. Note that a Command may have multiple requirements, and
 * {@link edu.wpi.first.wpilibj.command.Command#requires(Subsystem) requires(...)} should be
 ...
 * then {@link edu.wpi.first.wpilibj.command.Command#cancel() cancel()} will be called and the command will be removed
...
public abstract class Command implements NamedSendable {
     ...
     * This will call {@link edu.wpi.first.wpilibj.command.Command#interrupted() interrupted()} or {@link edu.wpi.first.wpilibj.command.Command#end() end()}.
     */
    ...
    /**
     * A shadow method called before {@link edu.wpi.first.wpilibj.command.Command#initialize() initialize()}
     */
    void _initialize() {
    }
    ...
    /**
     * A shadow method called before {@link edu.wpi.first.wpilibj.command.Command#execute() execute()}
     */
    void _execute() {
    }
     ...
     * and {@link edu.wpi.first.wpilibj.command.Command#end() end()} will be called.
     * <p/>
     * <p>It may be useful for a team to reference the {@link edu.wpi.first.wpilibj.command.Command#isTimedOut() isTimedOut()} method
    ...
    /**
     * A shadow method called after {@link edu.wpi.first.wpilibj.command.Command#end() end()}.
     */
    void _end() {
    }

    /**
     * Called when the command ends because somebody called {@link edu.wpi.first.wpilibj.command.Command#cancel() cancel()}
    ...
    /**
     * A shadow method called after {@link edu.wpi.first.wpilibj.command.Command#interrupted() interrupted()}.
     */
    void _interrupted() {
    }
     ...
     * This is called right before {@link edu.wpi.first.wpilibj.command.Command#initialize() initialize()} is, inside the
     * {@link edu.wpi.first.wpilibj.command.Command#run() run()} method.
     */
    ...
    /**
     * Returns whether or not the {@link edu.wpi.first.wpilibj.command.Command#timeSinceInitialized() timeSinceInitialized()}
    ...
    /**
     * Returns the requirements (as an {@link java.util.Enumeration Enumeration} of {@link Subsystem Subsystems}) of this command
     *
     * @return the requirements (as an {@link java.util.Enumeration Enumeration} of {@link Subsystem Subsystems}) of this command
     */
     ...
     * @throws IllegalUseOfCommandException if this {@link edu.wpi.first.wpilibj.command.Command} already is already in a group
     */
     ...
     * not have yet called {@link edu.wpi.first.wpilibj.command.Command#interrupted()}.
     *
     ...
     * Will return null if this {@link edu.wpi.first.wpilibj.command.Command} is not in a group.
     *
    ...
    /**
     * Sets whether or not this {@link edu.wpi.first.wpilibj.command.Command} should run when the robot is disabled.
     * <p/>
    ...
    /**
     * Returns whether or not this {@link edu.wpi.first.wpilibj.command.Command} will run when the robot is disabled, or if it will cancel itself.
     *
     * @return whether or not this {@link edu.wpi.first.wpilibj.command.Command} will run when the robot is disabled, or if it will cancel itself
     */
    ...
    /**
     * The string representation for a {@link edu.wpi.first.wpilibj.command.Command} is by default its name.
     *

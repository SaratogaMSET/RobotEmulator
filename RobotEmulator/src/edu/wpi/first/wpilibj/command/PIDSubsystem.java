...
/**
 * This class is designed to handle the case where there is a {@link edu.wpi.first.wpilibj.command.Subsystem}
 * which uses a single {@link edu.wpi.first.wpilibj.PIDController} almost constantly (for instance,
...
public abstract class PIDSubsystem extends Subsystem implements Sendable {
    ...
    /**
     * Instantiates a {@link edu.wpi.first.wpilibj.command.PIDSubsystem} that will use the given p, i and d values.
     *
     * @param name the name
    ...
    /**
     * Instantiates a {@link edu.wpi.first.wpilibj.command.PIDSubsystem} that will use the given p, i and d values.  It will also space the time
    ...
    /**
     * Returns the {@link edu.wpi.first.wpilibj.PIDController} used by this {@link edu.wpi.first.wpilibj.command.PIDSubsystem}.
     ...
     * the range defined by {@link edu.wpi.first.wpilibj.command.PIDSubsystem#setSetpointRange(double, double) setSetpointRange(...)}.</p>
     *
     * @return the {@link edu.wpi.first.wpilibj.PIDController} used by this {@link edu.wpi.first.wpilibj.command.PIDSubsystem}
     */
     ...
     * <p/>
     * <p>All subclasses of {@link edu.wpi.first.wpilibj.command.PIDSubsystem} must override this method.</p>
     *
    ...
    /**
     * Enables the internal {@link edu.wpi.first.wpilibj.PIDController}
     */
    public void enable() {
        controller.enable();
    }
    ...
    /**
     * Disables the internal {@link edu.wpi.first.wpilibj.PIDController}
     */
    public void disable() {
        controller.disable();
    }

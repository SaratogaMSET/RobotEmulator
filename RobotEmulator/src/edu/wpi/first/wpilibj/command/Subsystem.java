 ...
 * <p/>
 * <p>Subsystems are used within the command system as requirements for {@link edu.wpi.first.wpilibj.command.Command}.
...
//                throw new IllegalUseOfCommandException("A default command cannot require multiple subsystems");
     ...
     * Sometimes, the {@link edu.wpi.first.wpilibj.command.Subsystem} is told that it has no command while the {@link edu.wpi.first.wpilibj.command.Scheduler}

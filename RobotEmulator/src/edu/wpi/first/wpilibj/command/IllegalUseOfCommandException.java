...
public class IllegalUseOfCommandException extends RuntimeException {
    ...
    /**
     * Instantiates an {@link edu.wpi.first.wpilibj.command.IllegalUseOfCommandException}.
     */
    public IllegalUseOfCommandException() {
    }

    /**
     * Instantiates an {@link edu.wpi.first.wpilibj.command.IllegalUseOfCommandException} with the given message.
     *

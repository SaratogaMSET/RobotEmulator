 ...
 * then be saved to the file when {@link edu.wpi.first.wpilibj.Preferences#save() save()} is
 * called.</p>
 * <p/>
 ...
 * that represents non-existence in the {@link edu.wpi.first.wpilibj.Preferences} table</p>
 *
...
public class Preferences {
     ...
     * @throws edu.wpi.first.wpilibj.Preferences.ImproperPreferenceKeyException if the key contains an illegal
     *                                                                          character
     */
     ...
     * do that you must call {@link edu.wpi.first.wpilibj.Preferences#save() save()} (which must be
     ...
     * @throws edu.wpi.first.wpilibj.Preferences.ImproperPreferenceKeyException if the key contains any whitespace
     *                                                                          or an equals sign
     */
     ...
     * @param backup the value to return if none exists in the table
     * @return either the value in the table, or the backup
     * @throws edu.wpi.first.wpilibj.Preferences.IncompatibleTypeException if the value in the table can not be
     *                                                                     converted to an int
     */
     ...
     * {@link edu.wpi.first.wpilibj.IterativeRobot#teleopPeriodic()}.</p>
     * <p/>
     ...
     * in its own thread when {@link edu.wpi.first.wpilibj.Preferences#save() save()} is called.
     */
    private void write() {
        synchronized (lock) {
            synchronized (fileLock) {
     ...
     * comments will still be there after {@link edu.wpi.first.wpilibj.Preferences#save() save()} is
     * called.
     */
    private static class Comment {
         ...
         * @throws java.io.IOException if the stream has a problem
         */
    ...
    public static class ImproperPreferenceKeyException extends RuntimeException {
         ...
         * table. If not, then a {@link edu.wpi.first.wpilibj.Preferences.ImproperPreferenceKeyException} will be
         * thrown.
         *

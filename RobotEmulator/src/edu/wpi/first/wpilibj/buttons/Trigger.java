 ...
 * only have to write the {@link edu.wpi.first.wpilibj.buttons.Trigger#get()} method to get the full functionality
...
public abstract class Trigger implements Sendable {
    ...
    /**
     * An internal class of {@link edu.wpi.first.wpilibj.buttons.Trigger}.  The user should ignore this, it is

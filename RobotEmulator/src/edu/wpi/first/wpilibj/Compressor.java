...
public class Compressor extends SensorBase implements IDevice, LiveWindowSendable {
    ...
    private void initCompressor(final int pressureSwitchSlot,
        ...
        m_enabled = false;
        m_pressureSwitch = new DigitalInput(pressureSwitchSlot, pressureSwitchChannel, false);
        m_relay = new Relay(compresssorRelaySlot, compressorRelayChannel, Relay.Direction.kForward, false);
    ...
    /**
     * Get the state of the isEnabled flag.
     * Return the state of the isEnabled flag for the compressor and pressure switch
     * combination.
     *

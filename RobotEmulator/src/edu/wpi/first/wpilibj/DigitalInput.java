...
public class DigitalInput extends DigitalSource implements IInputOutput, LiveWindowSendable {
    ...
    public DigitalInput(int aChannel, boolean shouldPutOnGui) {
        initDigitalInput(getDefaultDigitalModule(), aChannel, shouldPutOnGui);
    }


    public DigitalInput(int aSlot, int aChannel, boolean sbouldPutOnGui) {
        initDigitalInput(aSlot, aChannel, sbouldPutOnGui);
    }
     ...
     */
    private void initDigitalInput(int moduleNumber, int channel, boolean shouldPutOnGui) {
        ...
        if (shouldPutOnGui)
            RobotEmulator.getInstance().addDigitalInput(this);
    }
    ...
    public DigitalInput(int channel) {
        initDigitalInput(getDefaultDigitalModule(), channel, true);
    }
    ...
    public DigitalInput(int moduleNumber, int channel) {
        initDigitalInput(moduleNumber, channel, true);
    }
...
//            return false;
//        }
        return RobotEmulator.getInstance().getDigitalInput(this);
    }

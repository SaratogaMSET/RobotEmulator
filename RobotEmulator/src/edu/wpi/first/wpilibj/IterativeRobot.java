 ...
 * - AutonomousInit() -- called each and every time isAutonomousMode is entered from another mode
...
public class IterativeRobot extends RobotBase {
     ...
     * the status of initialization for disabled, isAutonomousMode, and teleop code.
     */
    public IterativeRobot() {
        // set status for initialization of disabled, isAutonomousMode, and teleop code.
        ...
        while (true) {
            ...
            if (isDisabled()) {
                ...
                if (!m_autonomousInitialized) {
                    ...
                    // whenever entering isAutonomousMode mode, before calling
                    // "Autonomous_Init()"
                    autonomousInit();
    ...
    /**
     * Initialization code for isAutonomousMode mode should go here.
     * <p/>
     * Users should override this method for initialization code which will be called each time
     * the robot enters isAutonomousMode mode.
     */
   ...
   /* ----------- Overridable periodic code -----------------*/
    ...
    /**
     * Periodic code for isAutonomousMode mode should go here.
     * <p/>
     * Users should override this method for code which will be called periodically at a regular
     * rate while the robot is in isAutonomousMode mode.
     */

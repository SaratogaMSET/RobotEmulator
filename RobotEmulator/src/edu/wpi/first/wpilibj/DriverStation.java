...
//                    m_enhancedIO.updateData();
    ...
    protected synchronized void getData() {
        ...
        if (!lastEnabled && isEnabled()) {
            // If starting teleop, assume that isAutonomousMode just took up 15 seconds
            if (isAutonomous()) {
     ...
     * robot to be isEnabled.
     *
     * @return True if the robot is isEnabled, false otherwise.
     */
    ...
    /**
     * Gets a value indicating whether the Driver Station requires the
     * robot to be running in isAutonomousMode mode.
     *
     * @return True if isAutonomousMode mode should be isEnabled, false otherwise.
     */
    public boolean isAutonomous() {
        return m_controlData.isAutonomousMode();
    }
     ...
     *
     * @return True if test mode should be isEnabled, false otherwise.
     */
    public boolean isTest() {
        return m_controlData.isTestMode();
    }
     ...
     *
     * @return True if operator-controlled mode should be isEnabled, false otherwise.
     */
    public boolean isOperatorControl() {
        return !(m_controlData.isAutonomousMode() || m_controlData.isTestMode());
    }
...
//        return m_enhancedIO;
     ...
     * At the beginning of isAutonomousMode, the time is reset to 0.0 seconds
     * At the beginning of teleop, the time is reset to +15.0 seconds
     * If the robot is disabled, this returns 0.0 seconds
     * Warning: This is not an official time (so it cannot be used to argue with referees)
     *
     * @return Match time in seconds since the beginning of isAutonomousMode
     */
     ...
     * for diagnostic purposes only
     *
     * @param entering If true, starting isAutonomousMode code; if false, leaving isAutonomousMode code
     */
